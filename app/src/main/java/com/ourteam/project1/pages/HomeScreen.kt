...
fun Content(modifier: Modifier = Modifier) {
    val imageSlider = listOf(
        painterResource(id = R.drawable.image), // Ganti dengan gambar yang sesuai
    ...
    Column(
        ...
        Image(
            ...
            modifier = modifier.width(120.dp).padding(15.dp)
        )
...
//                 .height(150.dp)
//                 .fillMaxWidth()
//                 // memindahkan object gambar slider sedikit ke atas
//                 .offset(y = (-40).dp)
//         ) { page ->
//             Card(
//                 shape = RoundedCornerShape(12.dp),
...
//                 .align(Alignment.CenterHorizontally)
//                 .padding(4.dp)
//                 // memindahkan object page indicator sedikit ke atas
//                 .offset(y = (-30).dp),
//             activeColor = Color.White,
//             inactiveColor = Color.DarkGray
//         )
        
//         // Spacer(modifier = Modifier.height(5.dp)) // Jarak antara slider dan section
//         Text(
//         text = "Popular Now",
//         fontSize = 24.sp,
//         fontWeight = FontWeight.Bold,
